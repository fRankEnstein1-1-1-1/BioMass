      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="mx-auto w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mb-4 shadow-lg">
            ...
            <p className="text-slate-400 mt-1">Start analysing vegetation biomass</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Full Name */}
            <div>
              <label className="text-xs font-medium text-slate-400 block mb-2">FULL NAME</label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-800 border ${errors.name ? 'border-red-500' : 'border-slate-700'} 
                             rounded-2xl px-11 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-800 border ${errors.email ? 'border-red-500' : 'border-slate-700'} 
                             rounded-2xl px-11 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-800 border ${errors.password ? 'border-red-500' : 'border-slate-700'} 
                             rounded-2xl px-11 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500`}
                  placeholder="••••••••"
                />
              </div>
            ...
            {/* Confirm Password */}
            <div>
              <label className="text-xs font-medium text-slate-400 block mb-2">CONFIRM PASSWORD</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500" size={18} />
                <input
                  type="password"
                  ...
                  className={`w-full bg-slate-800 border ${errors.confirm ? 'border-red-500' : 'border-slate-700'} 
                             rounded-2xl px-11 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500`}
                  placeholder="••••••••"
                />
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 disabled:bg-slate-700 
                         py-3.5 rounded-2xl text-white font-medium transition-all mt-2"
            >
              {loading ? (
                'Creating Account...'
              ) : (
